...
module Parent1 =  // set and get - PATCH resource/self OK
  ...
  let otherChild =
    define.Relationship
      ...
      .ToOne()
      .Get(fun ctx p -> ctx.Db.TryGetChild p.OtherChildId |> Option.defaultWith (fun () -> failwith "Not found"))
...
module Parent5 =
  ...
  let child : ToOneRelationship<Ctx2, Parent4, obj, string> =
    define.Relationship
      .Polymorphic()
      .ToOne()
...
let tests2 =
  testList "To-one relationship PATCH self" [
    ...
    testJob "Calls AfterModifySelf with the initial and new entity" {
      ...
      let pExpected = { Id = "p1"; Child = C2 { Id = "c2" }; OtherChildId = "c2" }
