...
let tests =
    testList "Strict mode" [
        ...
        testJob "GET resource: Returns errors for each unknown query parameter" {
            ...
            let! response =
                Request.createWithClient
                    client
                    Get
                    (Uri("http://example.com/as/1?a1=bar&a2=baz&fields[a]=&include=&skipLinks1&skipLinks2"))
                |> Request.jsonApiHeaders
                |> getResponse
        ...
        testJob "GET to-one relationship related: Returns errors for each unknown query parameter" {
            ...
            let! response =
                Request.createWithClient
                    client
                    Get
                    (Uri("http://example.com/as/1/toOne?a1=bar&a2=baz&fields[a]=&include=&skipLinks1&skipLinks2"))
                |> Request.jsonApiHeaders
                |> getResponse
        ...
        testJob "GET to-one nullable relationship related: Returns errors for each unknown query parameter" {
            ...
            let! response =
                Request.createWithClient
                    ...
                    Get
                    (Uri(
                        "http://example.com/as/1/toOneNullable?a1=bar&a2=baz&fields[a]=&include=&skipLinks1&skipLinks2"
                    ))
                |> Request.jsonApiHeaders
                |> getResponse
        ...
        testJob
            "GET to-one nullable relationship related: Does not return errors for unknown query parameters in warn-only mode" {
            let client = createServerAndGetClient true
        ...
        testJob "GET to-one nullable relationship self: Returns errors for each unknown query parameter" {
            ...
            let! response =
                Request.createWithClient
                    ...
                    Get
                    (Uri(
                        "http://example.com/as/1/relationships/toOneNullable?a1=bar&a2=baz&fields[a]=&include=&skipLinks1&skipLinks2"
                    ))
                |> Request.jsonApiHeaders
                |> getResponse
        ...
        testJob
            "GET to-one nullable relationship self: Does not return errors for unknown query parameters in warn-only mode" {
            let client = createServerAndGetClient true
        ...
        testJob
            "PATCH to-one nullable relationship self: Does not return errors for unknown query parameters in warn-only mode" {
            let client = createServerAndGetClient true
        ...
        testJob "GET to-many relationship related: Returns errors for each unknown query parameter" {
            ...
            let! response =
                Request.createWithClient
                    client
                    Get
                    (Uri("http://example.com/as/1/toMany?a1=bar&a2=baz&fields[a]=&include=&skipLinks1&skipLinks2"))
                |> Request.jsonApiHeaders
                |> getResponse
        ...
        testJob
            "GET to-many relationship related: Does not return errors for unknown query parameters in warn-only mode" {
            let client = createServerAndGetClient true
        ...
        testJob "GET to-many relationship self: Returns errors for each unknown query parameter" {
            ...
            let! response =
                Request.createWithClient
                    ...
                    Get
                    (Uri(
                        "http://example.com/as/1/relationships/toMany?a1=bar&a2=baz&fields[a]=&include=&skipLinks1&skipLinks2"
                    ))
                |> Request.jsonApiHeaders
                |> getResponse
        ...
        testJob
            "DELETE to-many relationship self: Does not return errors for unknown query parameters in warn-only mode" {
            let client = createServerAndGetClient true
        ...
        for namePrefix, method in [ ("GET", Get); ("POST", Post); ("PATCH", Patch); ("DELETE", Delete) ] do
            ...
            testJob $"{namePrefix} custom operation without validation does not validate query parameters" {
                ...
                let! response =
                    Request.createWithClient
                        ...
                        method
                        (Uri(
                            "http://example.com/as/1/customOpWithoutValidation?a1=bar&a2=baz&fields[a]=&include=&skipLinks1&skipLinks2"
                        ))
                    |> Request.jsonApiHeaders
                    |> getResponse
            ...
            testJob $"{namePrefix} custom operation with validation: Returns errors for each unknown query parameter" {
                ...
                let! response =
                    Request.createWithClient
                        ...
                        method
                        (Uri(
                            "http://example.com/as/1/customOpWithValidation?customQueryParam=foo&a1=bar&a2=baz&fields[a]=&include=&skipLinks1&skipLinks2"
                        ))
                    |> Request.jsonApiHeaders
                    |> getResponse
                ...
                test
                    <@ json |> getPath "errors[0].detail" = "Query parameter 'a1' is not recognized for this operation" @>

                test <@ json |> getPath "errors[0].source.parameter" = "a1" @>
                test <@ json |> getPath "errors[1].status" = "400" @>

                test
                    <@ json |> getPath "errors[1].detail" = "Query parameter 'a2' is not recognized for this operation" @>
            ...
            testJob
                $"{namePrefix} custom operation with validation: Does not return errors for unknown query parameters in warn-only mode" {
                let client = createServerAndGetClient true
        ...
        testJob "Does not return errors if an allowed query parameter is used multiple times" {
            ...
            let! response =
                Request.createWithClient
                    client
                    Get
                    (Uri("http://example.com/as?customQueryParam=foo&customQueryParam=bar"))
                |> Request.jsonApiHeaders
                |> getResponse
