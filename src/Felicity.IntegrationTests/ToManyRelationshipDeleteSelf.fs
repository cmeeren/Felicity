...
let tests =
    testList "To-many relationship DELETE self" [
        ...
        testJob "Returns 403 if relationship is not settable" {
            ...
            test
                <@
                    json |> getPath "errors[0].detail" = "Relationship 'children' on type 'parent3' does not support removing members using DELETE (other resource types in collection 'parents' may have a relationship called 'children' that supports DELETE)"
                @>
        ...
        testJob "Returns 403 if relationship is not settable but supports PATCH" {
            ...
            test
                <@
                    json |> getPath "errors[0].detail" = "Relationship 'supportsPatch' on type 'parent3' does not support removing members using DELETE; it supports PATCH to replace items (other resource types in collection 'parents' may have a relationship called 'supportsPatch' that supports DELETE)"
                @>
        ...
        testJob "Returns 403 if relationship is not settable but supports POST" {
            ...
            test
                <@
                    json |> getPath "errors[0].detail" = "Relationship 'supportsPost' on type 'parent3' does not support removing members using DELETE; it supports POST to add items (other resource types in collection 'parents' may have a relationship called 'supportsPost' that supports DELETE)"
                @>
        ...
        testJob "Returns 403 if relationship is not settable but supports PATCH/POST" {
            ...
            test
                <@
                    json |> getPath "errors[0].detail" = "Relationship 'supportsPatchAndPost' on type 'parent3' does not support removing members using DELETE; it supports PATCH/POST to replace/add items (other resource types in collection 'parents' may have a relationship called 'supportsPatchAndPost' that supports DELETE)"
                @>
        ...
        testJob "Returns 403 if relationship is not settable for any resource but supports PATCH" {
            ...
            test
                <@
                    json |> getPath "errors[0].detail" = "Relationship 'supportsPatchUnique' does not support removing members using DELETE for any resource in collection 'parents'; it may support PATCH to replace items"
                @>
        ...
        testJob "Returns 403 if relationship is not settable for any resource but supports POST" {
            ...
            test
                <@
                    json |> getPath "errors[0].detail" = "Relationship 'supportsPostUnique' does not support removing members using DELETE for any resource in collection 'parents'; it may support POST to add items"
                @>
        ...
        testJob "Returns 403 if relationship is not settable for any resource but supports PATCH/POST" {
            ...
            test
                <@
                    json |> getPath "errors[0].detail" = "Relationship 'supportsPatchAndPostUnique' does not support removing members using DELETE for any resource in collection 'parents'; it may support PATCH/POST to replace/add items"
                @>
...
"""
        ...
        testJob "Returns 403 if relationship exists but is not settable for any resource" {
            ...
            test
                <@
                    json |> getPath "errors[0].detail" = "Relationship 'children' does not support removing members using DELETE for any resource in collection 'parents'"
                @>
        ...
        testJob "Returns 404 if resource does not exist" {
            ...
            let! response =
                Request.delete (Ctx.WithDb db) "/parents/invalidId/relationships/children"
                |> getResponse
