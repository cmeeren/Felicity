...
type RequestParser<'ctx, 'a> =
    ...
    member internal this.ParseWithConsumed
        ()
        ...
        task {
            ...
            if prohibitedErrs.IsEmpty then
                return!
                    ...
                    |> TaskResult.map (fun x -> Set.ofSeq this.consumedFields, Set.ofSeq this.consumedParams, x)
            else
                return Error prohibitedErrs
        }

    member this.ParseTask() : Task<Result<'a, Error list>> =
        this.ParseWithConsumed() |> TaskResult.map (fun (_, _, x) -> x)

    member this.ParseAsync() : Async<Result<'a, Error list>> = this.ParseTask() |> Task.toAsync

    member private this.MarkAsConsumed(getter: RequestGetter<'ctx, 'b>) =
        getter.FieldName |> Option.iter (this.consumedFields.Add >> ignore)
        getter.QueryParamName |> Option.iter (this.consumedParams.Add >> ignore)
        this
    ...
    member this.AddTaskRes
        (
            set: 'b -> 'c -> 'a -> Task<Result<'a, Error list>>,
            getter: OptionalRequestGetter<'ctx, 'b>,
    ...
    member this.AddAsyncRes
        (
            set: 'b -> 'c -> 'a -> Async<Result<'a, Error list>>,
            getter: OptionalRequestGetter<'ctx, 'b>,
            getC: RequestGetter<'ctx, 'c>
        ) =
    ...
    member this.IgnoreStrictMode(getter: OptionalRequestGetter<'ctx, 'b>) = this.MarkAsConsumed(getter)

    member this.Map(f: 'a -> 'b) : RequestParser<'ctx, 'b> = {
        includedTypeAndId = this.includedTypeAndId
        consumedFields = this.consumedFields
        consumedParams = this.consumedParams
    ...
    member this.BindAsync(f: 'a -> Async<'b>) : RequestParser<'ctx, 'b> = this.BindTask(Task.liftAsync f)
...
type RequestParserHelper<'ctx> internal (ctx: 'ctx, req: Request, ?includedTypeAndId) =
    ...
    let consumedFields = HashSet<FieldName>()
    let consumedParams = HashSet<QueryParamName>()

    member _.GetRequiredTask(param: RequestGetter<'ctx, 'a>) : Task<Result<'a, Error list>> =
        param.FieldName |> Option.iter (consumedFields.Add >> ignore)
        param.QueryParamName |> Option.iter (consumedParams.Add >> ignore)
        ...
        RequestParser<'ctx, 'a>
            .Create(
                ...
                ctx,
                req,
                fun c r -> param.Get(c, r, includedTypeAndId)
            )
            .ParseTask()
    ...
    member this.ForAsync(create: Async<'a>) = this.ForTask(create |> Task.fromAsync)

    member this.ForRes(value: Result<'a, Error list>) = this.ForTaskRes(value |> Task.result)
    ...
    member _.ForTaskRes(create: 'p1 -> Task<Result<'a, Error list>>, p1: RequestGetter<'ctx, 'p1>) =
        [| p1.FieldName |] |> Array.iter (Option.iter (consumedFields.Add >> ignore))
    ...
    member _.ForTaskRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> Task<Result<'a, Error list>>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
    ...
    member this.ForAsyncRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> Async<Result<'a, Error list>>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>
        ) =
    ...
    member this.ForRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> Result<'a, Error list>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>
        ) =
    ...
    member _.ForTaskRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> 'p4 -> Task<Result<'a, Error list>>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>,
    ...
    member this.ForAsyncRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> 'p4 -> Async<Result<'a, Error list>>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>,
            p4: RequestGetter<'ctx, 'p4>
    ...
    member this.ForRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> 'p4 -> Result<'a, Error list>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>,
            p4: RequestGetter<'ctx, 'p4>
    ...
    member _.ForTaskRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> 'p4 -> 'p5 -> Task<Result<'a, Error list>>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>,
            p4: RequestGetter<'ctx, 'p4>,
    ...
    member this.ForAsyncRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> 'p4 -> 'p5 -> Async<Result<'a, Error list>>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>,
            p4: RequestGetter<'ctx, 'p4>,
    ...
    member this.ForRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> 'p4 -> 'p5 -> Result<'a, Error list>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>,
            p4: RequestGetter<'ctx, 'p4>,
    ...
    member _.ForTaskRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> 'p4 -> 'p5 -> 'p6 -> Task<Result<'a, Error list>>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>,
            p4: RequestGetter<'ctx, 'p4>,
    ...
    member this.ForAsyncRes
        ...
        this.ForTaskRes((fun p1 p2 p3 p4 p5 p6 -> create p1 p2 p3 p4 p5 p6 |> Task.fromAsync), p1, p2, p3, p4, p5, p6)
    ...
    member this.ForTask
        ...
        this.ForTaskRes((fun p1 p2 p3 p4 p5 p6 -> create p1 p2 p3 p4 p5 p6 |> Task.map Ok), p1, p2, p3, p4, p5, p6)
    ...
    member this.ForAsync
        ...
        this.ForTask((fun p1 p2 p3 p4 p5 p6 -> create p1 p2 p3 p4 p5 p6 |> Task.fromAsync), p1, p2, p3, p4, p5, p6)
    ...
    member this.ForRes
        ...
        this.ForTaskRes((fun p1 p2 p3 p4 p5 p6 -> create p1 p2 p3 p4 p5 p6 |> Task.result), p1, p2, p3, p4, p5, p6)
    ...
    member _.ForTaskRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> 'p4 -> 'p5 -> 'p6 -> 'p7 -> Task<Result<'a, Error list>>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>,
            p4: RequestGetter<'ctx, 'p4>,
    ...
    member _.ForTaskRes
        (
            create: 'p1 -> 'p2 -> 'p3 -> 'p4 -> 'p5 -> 'p6 -> 'p7 -> 'p8 -> Task<Result<'a, Error list>>,
            p1: RequestGetter<'ctx, 'p1>,
            p2: RequestGetter<'ctx, 'p2>,
            p3: RequestGetter<'ctx, 'p3>,
            p4: RequestGetter<'ctx, 'p4>,
