...
type NonNullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> = internal {
    ...
    interface FieldQueryParser<'ctx, 'entity, 'attr, 'serialized> with
        member this.Name = this.name
        member this.ToDomain ctx getInfo serialized = this.toDomain ctx getInfo serialized
    ...
    member this.GetAsync(get: Func<'ctx, 'entity, Async<'attr>>) = this.GetTask(Task.liftAsyncFunc2 get)

    member this.GetAsync(get: Func<'entity, Async<'attr>>) = this.GetTask(Task.liftAsyncFunc get)

    member this.GetSkip(get: Func<'ctx, 'entity, 'attr Skippable>) = this.GetTaskSkip(Task.liftFunc2 get)

    member this.GetSkip(get: Func<'entity, 'attr Skippable>) = this.GetTaskSkip(Task.liftFunc get)
    ...
    member this.SetAsync(set: 'setCtx -> 'attr -> 'entity -> Async<'entity>) = this.SetTask(Task.liftAsync3 set)

    member this.SetAsync(set: 'attr -> 'entity -> Async<'entity>) = this.SetTask(Task.liftAsync2 set)

    member this.SetRes(set: 'setCtx -> 'attr -> 'entity -> Result<'entity, Error list>) =
        this.SetTaskRes(Task.lift3 set)

    member this.SetRes(set: 'attr -> 'entity -> Result<'entity, Error list>) = this.SetTaskRes(Task.lift2 set)

    member this.Set(set: 'setCtx -> 'attr -> 'entity -> 'entity) = this.SetTaskRes(TaskResult.lift3 set)
...
type NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> = internal {
    ...
    member internal this.nullableFromDomain = Option.map this.fromDomain
    ...
    interface FieldQueryParser<'ctx, 'entity, 'attr, 'serialized> with
        member this.Name = this.name
        member this.ToDomain ctx info serialized = this.toDomain ctx info serialized
    ...
    member this.GetAsync(get: Func<'ctx, 'entity, Async<'attr option>>) = this.GetTask(Task.liftAsyncFunc2 get)

    member this.GetAsync(get: Func<'entity, Async<'attr option>>) = this.GetTask(Task.liftAsyncFunc get)

    member this.GetSkip(get: Func<'ctx, 'entity, 'attr option Skippable>) = this.GetTaskSkip(Task.liftFunc2 get)

    member this.GetSkip(get: Func<'entity, 'attr option Skippable>) = this.GetTaskSkip(Task.liftFunc get)
    ...
    member this.SetAsync(set: 'setCtx -> 'attr option -> 'entity -> Async<'entity>) = this.SetTask(Task.liftAsync3 set)

    member this.SetAsync(set: 'attr option -> 'entity -> Async<'entity>) = this.SetTask(Task.liftAsync2 set)

    member this.SetRes(set: 'setCtx -> 'attr option -> 'entity -> Result<'entity, Error list>) =
        this.SetTaskRes(Task.lift3 set)

    member this.SetRes(set: 'attr option -> 'entity -> Result<'entity, Error list>) = this.SetTaskRes(Task.lift2 set)

    member this.Set(set: 'setCtx -> 'attr option -> 'entity -> 'entity) = this.SetTaskRes(TaskResult.lift3 set)
...
module private AttributeParsers =
    ...
    let parseDateTimeOffset =
        ...
        let errMsg =
            "The value must be a valid ISO 8601-1:2019 date-time including an offset (e.g. 'Z' or '+01:00')"

        fun (value: string) ->
            try
                let res = JsonSerializer.Deserialize<DateTimeOffset>("\"" + value + "\"")
                if r.IsMatch value then Ok res else Error errMsg
            with _ ->
                Error errMsg

    let stringifyDateTimeOffset =
        JsonSerializer.Serialize<DateTimeOffset> >> fun s -> s.Trim('"')
...
type NullableAttributeHelper<'ctx, 'setCtx, 'entity>
    ...
    member _.MapSetContextTaskRes
        ...
        : NullableAttributeHelper<'ctx, 'mappedSetCtx, 'entity> =
        NullableAttributeHelper<'ctx, 'mappedSetCtx, 'entity>(mapSetCtx)

    member this.MapSetContextAsyncRes
        (mapSetCtx: 'ctx -> 'entity -> Async<Result<'mappedSetCtx, Error list>>)
        : NullableAttributeHelper<'ctx, 'mappedSetCtx, 'entity> =
        this.MapSetContextTaskRes(Task.liftAsync2 mapSetCtx)

    member this.MapSetContextTask
        (mapSetCtx: 'ctx -> 'entity -> Task<'mappedSetCtx>)
        : NullableAttributeHelper<'ctx, 'mappedSetCtx, 'entity> =
        this.MapSetContextTaskRes(fun ctx e -> mapSetCtx ctx e |> Task.map Ok)

    member this.MapSetContextAsync
        (mapSetCtx: 'ctx -> 'entity -> Async<'mappedSetCtx>)
        : NullableAttributeHelper<'ctx, 'mappedSetCtx, 'entity> =
        this.MapSetContextTask(Task.liftAsync2 mapSetCtx)

    member this.MapSetContextRes
        (mapSetCtx: 'ctx -> 'entity -> Result<'mappedSetCtx, Error list>)
        : NullableAttributeHelper<'ctx, 'mappedSetCtx, 'entity> =
        this.MapSetContextTaskRes(Task.lift2 mapSetCtx)

    member this.MapSetContext
        (mapSetCtx: 'ctx -> 'entity -> 'mappedSetCtx)
        : NullableAttributeHelper<'ctx, 'mappedSetCtx, 'entity> =
    ...
    member this.SimpleBool
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, bool, bool> =
        this.SimpleUnsafe(name)

    member this.SimpleByte
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, byte, byte> =
        this.SimpleUnsafe(name)

    member this.SimpleInt
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, int, int> =
        this.SimpleUnsafe(name)

    member this.SimpleInt64
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, int64, int64> =
        this.SimpleUnsafe(name)

    member this.SimpleDecimal
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, decimal, decimal> =
        this.SimpleUnsafe(name)

    member this.SimpleFloat
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, float, float> =
        this.SimpleUnsafe(name)

    member this.SimpleString
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, string, string> =
        this.SimpleUnsafe(name)

    member this.SimpleChar
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, string, string> =
        this.SimpleUnsafe(name)

    member this.SimpleDateTime
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, DateTime, DateTime> =
        this.SimpleUnsafe(name)

    member this.SimpleDateTimeOffsetAllowMissingOffset
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, DateTimeOffset, DateTimeOffset> =
        this.SimpleUnsafe(name)
    ...
    member this.SimpleGuid
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, Guid, Guid> =
        this.SimpleUnsafe(name)

    member this.SimpleUri
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NullableAttribute<'ctx, 'setCtx, 'entity, Uri, Uri> =
        this.SimpleUnsafe(name)
    ...
    member this.ParsedTaskRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Task<Result<'attr, Error list>>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
    ...
    member this.ParsedTaskRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Task<Result<'attr, string>>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member this.ParsedTaskRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Task<Result<'attr, string>>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member this.ParsedTaskRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Task<Result<'attr, string list>>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member this.ParsedTaskRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Task<Result<'attr, string list>>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member this.ParsedAsyncRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Async<Result<'attr, Error list>>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
    ...
    member this.ParsedAsyncRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Async<Result<'attr, string>>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes(fromDomain, Task.liftAsync2 toDomain, name)
    ...
    member this.ParsedAsyncRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Async<Result<'attr, string>>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes(fromDomain, Task.liftAsync toDomain, name)
    ...
    member this.ParsedAsyncRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Async<Result<'attr, string list>>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes(fromDomain, Task.liftAsync2 toDomain, name)
    ...
    member this.ParsedAsyncRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Async<Result<'attr, string list>>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes(fromDomain, Task.liftAsync toDomain, name)
    ...
    member this.ParsedTaskOpt
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Task<'attr option>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member this.ParsedTaskOpt
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Task<'attr option>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
            (fun _ getInfo v -> v |> toDomain |> Task.map (Result.requireSome [ invalidParsedNone (getInfo v) ])),
            name
        )
    ...
    member this.ParsedAsyncOpt
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Async<'attr option>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
    ...
    member this.ParsedAsyncOpt
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Async<'attr option>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
    ...
    member this.ParsedTask
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Task<'attr>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
    ...
    member this.ParsedAsync
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Async<'attr>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
    ...
    member this.ParsedAsync
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Async<'attr>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
    ...
    member this.ParsedRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Result<'attr, Error list>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
    ...
    member this.ParsedRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Result<'attr, Error list>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
    ...
    member this.ParsedRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Result<'attr, string>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member this.ParsedRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Result<'attr, string>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member this.ParsedRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> Result<'attr, string list>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member this.ParsedRes
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> Result<'attr, string list>,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member this.ParsedOpt
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'ctx -> 'serialized -> 'attr option,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member this.ParsedOpt
        (
            fromDomain: 'attr -> 'serialized,
            toDomain: 'serialized -> 'attr option,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
        ) : NullableAttribute<'ctx, 'setCtx, 'entity, 'attr, 'serialized> =
        this.ParsedTaskRes'(
            fromDomain,
    ...
    member _.Enum
        (
            fromDomain: 'attr -> string,
            toDomainMap: (string * 'attr) list,
            [<CallerMemberName; Optional; DefaultParameterValue("")>] name: string
...
type AttributeHelper<'ctx, 'setCtx, 'entity> internal (mapSetCtx: 'ctx -> 'entity -> Task<Result<'setCtx, Error list>>)
    ...
    member this.MapSetContextAsyncRes
        (mapSetCtx: 'ctx -> 'entity -> Async<Result<'mappedSetCtx, Error list>>)
        : AttributeHelper<'ctx, 'mappedSetCtx, 'entity> =
        this.MapSetContextTaskRes(Task.liftAsync2 mapSetCtx)
    ...
    member this.SimpleBool
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, bool, bool> =
        this.SimpleUnsafe(name)

    member this.SimpleByte
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, byte, byte> =
        this.SimpleUnsafe(name)

    member this.SimpleInt
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, int, int> =
        this.SimpleUnsafe(name)

    member this.SimpleInt64
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, int64, int64> =
        this.SimpleUnsafe(name)

    member this.SimpleDecimal
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, decimal, decimal> =
        this.SimpleUnsafe(name)

    member this.SimpleFloat
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, float, float> =
        this.SimpleUnsafe(name)

    member this.SimpleString
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, string, string> =
        this.SimpleUnsafe(name)
    ...
    member this.SimpleDateTime
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, DateTime, DateTime> =
        this.SimpleUnsafe(name)

    member this.SimpleDateTimeOffsetAllowMissingOffset
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, DateTimeOffset, DateTimeOffset> =
        this.SimpleUnsafe(name)
    ...
    member this.SimpleGuid
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, Guid, Guid> =
        this.SimpleUnsafe(name)

    member this.SimpleUri
        ([<CallerMemberName; Optional; DefaultParameterValue("")>] name: string)
        : NonNullableAttribute<'ctx, 'setCtx, 'entity, Uri, Uri> =
        this.SimpleUnsafe(name)
